...
export default function Home() {
  return (
    <div className="relative isolate w-full min-h-screen overflow-hidden">
      ...
      <main className="relative mx-auto w-full max-w-5xl px-6 pt-16 pb-16 md:pt-20 md:pb-20">
        <section className="flex flex-col items-center text-center">
          ...
          >
            Um projeto europeu de investigação que reúne universidades e instituições para construir
            um futuro com mais e melhor cuidado para todos.
          </p>
...
function AuroraBackground() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute -bottom-32 -left-32 h-104 w-104 animate-glow-drift rounded-full bg-primary/10 blur-3xl [animation-delay:-8s]" />
    </div>
  );
}
