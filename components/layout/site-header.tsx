...
import logo from "@/public/hands_logo_transparent.png";
    ...
    >
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-4 px-6 md:h-18">
        <Link
          ...
          className="shrink-0 rounded-md focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50 font-extrabold font-heading flex flex-row items-center"
        >
          <Image src={logo} alt="LeTs Care Portugal" priority className="h-4 w-auto md:h-6" />
