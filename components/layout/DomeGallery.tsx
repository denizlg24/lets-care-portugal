          ...
          <div ref={sphereRef} className="sphere">
            {items.map((it) => (
              ...
              >
                <button
                  type="button"
                  className="item__image absolute block overflow-hidden cursor-pointer appearance-none border-0 p-0 bg-gray-200 transition-transform duration-300"
                ...
                >
                  {/* biome-ignore lint/performance/noImgElement: 3D-transformed tiles are positioned manually and mirror runtime-created <img> nodes; next/image cannot participate in this layout */}
                  <img
                    src={it.src}
                    draggable={false}
                    alt={it.alt}
